    ...
    IValidatableTrackingObject, IValidatableObject
  {
    ...
    protected bool GetIsChanged(string propertyName)
    {
      return _originalValues.ContainsKey(propertyName);
        ...
        //this setter method is typed, it has a type of TValue which is inferred from what is passed into it. If a List<decimal> is passed in, <TValue> is a List<decimal>.
